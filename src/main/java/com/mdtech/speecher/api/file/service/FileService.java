...
import com.mdtech.speecher.api.file.entity.AliUploadToken;
import com.mdtech.speecher.api.file.entity.OSSConfig;
import com.mdtech.speecher.api.file.entity.UploadOptions;
import com.mdtech.speecher.api.file.entity.UploadToken;
import com.mdtech.speecher.common.exception.DetailedException;
import com.mdtech.speecher.common.util.*;
import com.mdtech.speecher.common.util.UUIDCreatorFactory.UUIDCreator;
...
public class FileService {
    ...
    public File createTmpFile(String namespace, String extension) throws Exception {
        File dir = new File("/tmp/speecher-api", namespace);
        dir.mkdirs();
